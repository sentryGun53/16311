...
// local_3.c: Line following is now a function, added function to get robot to go to final destination
...
void goToDestination (int currentEdge, string letter) {
	...
	if (letter == "A" || letter == "C" || letter == "F" || letter == "H") distanceOnEdge = 1; // Closer to start because we tend to overshoot
	else if (letter == "B" || letter == "D" || letter == "G" || letter == "I") distanceOnEdge = 7;
	else if (letter == "E" || letter == "J") distanceOnEdge = 13;
